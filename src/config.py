...
def parse_args():
    ...
    parser.add_argument("--speaker-refs-root", type=str, required=True)
    ...
    precision.add_argument("--fp16", action="store_const", const="fp16", dest="mixed_precision")
    precision.add_argument("--bf16", action="store_const", const="bf16", dest="mixed_precision")
    precision.add_argument("--no-fp16", action="store_const", const="no", dest="mixed_precision")
    precision.add_argument("--no-mixed-precision", action="store_const", const="no", dest="mixed_precision")
    parser.set_defaults(mixed_precision="fp16" if torch.cuda.is_available() else "no")
